...
fn test_no_type_signature_for_terminators() {
    ...
    assert!(!output.contains(" : "), "Terminator should not have type signature");
...
fn test_round_trip_parsing() {
    ...
    let complex_type = ctx.intern_type(uvir::types::TypeKind::Complex { element_type: f32_type });
